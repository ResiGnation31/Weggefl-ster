...
export default async function handler(req) {
  ...
  try {
    ...
    const prompt = customPrompt || "Du bist ein sachlicher Reisebegleiter. Der Nutzer " + modeLabel + " gerade durch \"" + placeName + "\"." +
      ...
      "\nLAENGE: " + t.laenge +
      "\n\nREGELN: Nur Fakten aus den Informationen oben. Niemals erfinden. Fliessendes Deutsch. KEIN #. Direkt beginnen. Alle Zahlen ausschreiben (z.B. sechsundachtzigtausend statt 86000, neunzehnhundert statt 1900). Einzelne Betriebe und Unternehmen NUR erwaehnen wenn sie historisch oder kulturell bedeutsam sind (z.B. Gruendungsgeschichte, besondere Rolle in der Region). NIEMALS banale Details wie Mitarbeiterzahlen, Filialen oder Umsaetze erwaehnen. Allgemeine Hinweise auf Infrastruktur sind ok (z.B. "die Stadt hat eine lebhafte Gastronomie")." +
      (streetAlreadyMentioned ? " Den Strassennamen NICHT erwaehnen — er wurde bereits in einer vorherigen Story genannt." : "") +
      (raumtyp === "autobahn" || raumtyp === "landstrasse" ? " Sage NIEMALS dass man durch einen Ort faehrt — man faehrt VORBEI oder der Ort liegt IN DER NAEHE. Keine Formulierungen wie 'Sie fahren durch' oder 'Sie befinden sich in'." : "") +
