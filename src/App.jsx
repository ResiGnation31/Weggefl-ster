...
export default function App() {
  ...
  return (
    <div style={{ minHeight:"100vh", position:"relative", background:T.bg, fontFamily:"-apple-system,BlinkMacSystemFont,'SF Pro Text',sans-serif", color:T.text, overflowX:"hidden", transition:"background 0.3s, color 0.3s", paddingTop:"env(safe-area-inset-top)" }}>
        ...
        <div style={{ display:"flex", gap:6, marginBottom:14, background: isDark?"rgba(255,255,255,0.06)":"rgba(255,255,255,0.7)", borderRadius:16, padding:5, backdropFilter:"blur(8px)" }}>
          {[
            ...
            <div key={id} style={{ flex:1, position:"relative" }}>
              ...
              {activeDropdown===id && (
                <div style={{ position:"absolute", top:"calc(100% + 6px)", left:"50%", transform:"translateX(-50%)", zIndex:500, background: isDark?"rgba(30,26,22,0.97)":"rgba(252,249,244,0.97)", backdropFilter:"blur(24px)", borderRadius:14, padding:8, boxShadow:"0 8px 32px rgba(0,0,0,0.18)", minWidth:160, maxHeight:"60vh", overflowY:"auto" }}>
      ...
      {profileOpen && (
        <div onClick={() => setProfileOpen(false)} style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.4)", zIndex:500, backdropFilter:"blur(4px)" }}/>
      )}
